    ...
    return {
      ...
      tech: [
        ...
        },
        {
          id: 6,
          name: 'Unity',
          imageUrl: 'https://gpuopen.com/images/unitybrand_dark_new.VyK3QCk1.jpg',
          status: 'Intermediate'
        },
        {
          id: 7,
          name: 'Adobe Premiere Pro',
          imageUrl: 'https://static.vecteezy.com/system/resources/thumbnails/056/850/746/small/adobe-premiere-pro-logo-with-transparent-background-free-png.png',
          status: 'Intermediate'
        },
        {
          id: 8,
          name: 'Sketchup',
          imageUrl: 'https://www.axonware.com/catalog/images/sketchup-logo.png',
          status: 'Beginner'
        },
        {
          id: 9,
          name: 'Adobe Photoshop',
          imageUrl: 'https://logos-world.net/wp-content/uploads/2020/11/Adobe-Photoshop-Logo-2019-2020.png',
          status: 'Beginner'
        },
        {
          id: 10,
          name: 'Figma',
          imageUrl: 'https://blog.greggant.com/images/posts/2019-04-25-figma/Figma.png',
          status: 'Advance'
        },
        {
          id: 11,
        ...
        },
        {
          ...
          imageUrl: 'https://logos-world.net/wp-content/uploads/2025/07/Illustrator-Logo-2015.png',
          status: 'Beginner'
        },
        {
          id: 15,
          name: 'Blender',
          imageUrl: 'https://booking.biblioottawalibrary.ca/sites/default/files/blender.png',
          status: 'Intermediate'
        }  
      ],
      tools: [
        ...
        },
        {
          id: 5,
          name: 'Vuforia',
          imageUrl: 'https://miro.medium.com/v2/resize:fit:1400/1*z_37y_279Ehvriy9eDiaKA.png',
          status: 'Database Unity'
        },
      ]
    };
  }
...
<template>
  <div
    class="bg-[#1e1e1f] px-5 py-5 md:px-12 md:py-10 text-left border border-[#009dff] rounded-3xl text-amber-50 mx-3 mb-5">
      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="w-9/12 rounded-full mb-3 fadein-up"
            src="https://i.imgur.com/fYLrA7b.jpeg" alt="Foto">
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is Safa'at ihwatul afdal. I'm a web developer from Bogor, West Java. I
  ...
  <div class="px-5 py-5 md:px-12 md:py-10 text-left text-amber-50 mx-3">
    <article data-page="about">
      <header>
        <div class="text-2xl font-bold text-white mb-5 fadein-bot title-section flex items-center">
          <div class="h-[1px] w-10 bg-green-400 md:w-20 aos-init aos-animate" data-aos="zoom-in-left"
            data-aos-duration="600"></div>
          &nbsp; Skills
        </div>
      </header>
          ...
          <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 dark:text-gray-400 mb-5">
            <li class="mr-2">
              <button class="inline-block px-4 py-3 rounded-lg hover:text-white"
                :class="{ 'text-green-400 bg-green-400 bg-opacity-10': activeTab === 1 }" @click="activeTab = 1">Tech Stack</button>
            </li>
            <li class="mr-2">
              <button class="inline-block px-4 py-3 rounded-lg hover:text-white"
        ...
        <div v-show="activeTab === 1">
          <div class="grid grid-cols-2 gap-4 pb-32 md:grid-cols-3 md:gap-8 xl:grid-cols-4 xl:gap-10 2xl:gap-12">
            <div v-for="item in tech" :key="item.id">
              <div
                class="item-tech flex cursor-pointer items-center gap-2 rounded border border-green-400 px-2 py-2 hover:bg-green-400 hover:bg-opacity-10 md:gap-3 lg:px-3">
                ...
                <div class="flex items-center text-sm md:text-base lg:text-lg">
                  ...
                  <div
                    class="status-tech opacity-0 absolute mt-5 text-[10px] text-green-500 transition-all duration-300 md:text-xs lg:text-sm">
                    {{ item.status }}</div>
                </div>
              </div>
            </div>
